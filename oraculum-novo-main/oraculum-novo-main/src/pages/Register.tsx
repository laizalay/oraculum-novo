    ...
    <div className="flex min-h-screen items-center justify-center bg-[#1F3864] px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/70 text-sm">Criar conta</p>
        </div>
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-[#1F3864] font-semibold text-lg mb-4">Cadastro</h2>
          {error && (
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            Já tem conta?{" "}
            <Link to="/login" className="text-[#1F3864] font-semibold hover:underline">Entrar</Link>
          </p>
        </div>
      </div>
    </div>
